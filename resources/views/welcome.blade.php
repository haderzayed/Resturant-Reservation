<x-guest-layout>
  ...
  <section class="mt-8 bg-white">
    <div class="mt-4 text-center">
      <h3 class="text-2xl font-bold">Our Menues</h3>
    ...
    <div class="container w-full px-5 py-6 mx-auto">
      <div class="grid lg:grid-cols-4 gap-y-6">
                ...
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    <a href="{{route('menues.show',$menue->id)}}"> <img class="w-full h-48" src="{{Storage::url($menue->image)}}"
                    alt="Image" />
                    <div class="px-6 py-4">
  ...
  <section class="pt-4 pb-12 bg-gray-50">
    ...
    <div class="container grid gap-4 mx-auto lg:grid-cols-3">
      <div class="w-full rounded">
        <img width="500" height="500" src="{{Storage::url($category->image)}}">
      </div>
    </div>
    @empty
    No Categories
