<x-admin-layout>
   ...
   <div class="flex justify-end m-3 p-3">
    <a href="{{route('admin.admins.create')}}" class="btn-create  ">New Admin</a>
   </div>
                ...
                <div class="flex justify-center">
                    <div class="mb-3 xl:w-96">
                      ...
                      <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
                        <input type="search" name="name" class="form-control m-2 relative flex-auto min-w-0 block  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search By Admin Name" aria-label="Search" aria-describedby="button-addon2">
            ...
            <table class="w-full  text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="py-4 px-6">
                            {{$admin->created_at->format('h:i a m/d/Y')}}
                        </td>
                        <td class="py-4 px-6">
                            <div class="flex space-x-2">
                            <a href="{{route('admin.admins.edit',$admin->id)}}" class="px-4 py-2 bg-green-500  hover:bg-green-700 rounded-lg text-white">Edit</a>
