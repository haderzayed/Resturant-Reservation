    ...
    <!-- breadcrumb-area-end -->
     ...
     <div class="m-5 p-5 bg-gray-50 rounded-lg border border-gray-300 ">
        ...
        <form action="{{route('admin.admins.update',$admin->id)}}" method="post"  >
            ...
            <input type="text" value="{{old('name',$admin->name)}}" name="name" id="name" class=" text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-9/12 p-2.5 " placeholder="name" required>

            <label for="email" class="block m-3 text-sm font-medium text-gray-900 ">Email<span class="inline text-red-500 ">*<span></label>
            <input type="email" name="email" value="{{old('email',$admin->email)}}" id="email" class=" text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-9/12 p-2.5 " placeholder="Email" required>
