<x-admin-layout>
    ...
    <div class="flex justify-end m-3 p-3">
        <a href="{{route('admin.tables.create')}}" class="btn-create  ">New Table</a>
    </div>
             ...
             <div class="flex justify-center">
                <div class="mb-3 xl:w-96">
                  ...
                  <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
                    ...
                    <input type="search" name="location" class="form-control m-2 relative flex-auto min-w-0 block  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search By Location" aria-label="Search" aria-describedby="button-addon2">
                    <input type="search" name="status" class="form-control m-2 relative flex-auto min-w-0 block  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search By Status" aria-label="Search" aria-describedby="button-addon2">
                    <input type="search" name="guest_number" class="form-control m-2 relative flex-auto min-w-0 block  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search By Guest Number" aria-label="Search" aria-describedby="button-addon2">
